    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <?php
          $sw=mysqli_query($con,"select * from app_show where st_id in(select st_id from app_time_slot where screen_id in(select screen_id from  app_hall where cinema_id='".$_SESSION['theatre']."')) and status='1'");
