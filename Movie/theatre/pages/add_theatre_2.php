  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <?php
            $th=mysqli_query($con,"select * from app_cinemas where cinema_id='".$_SESSION['theatre']."'");
        ...
        <div class="box-body" id="screendtls">
          <?php
            $sr=mysqli_query($con,"select * from app_hall where cinema_id='".$_SESSION['theatre']."'");
              ...
              <th class="text-right col-md-3"><button data-toggle="modal" data-target="#view-modal" id="getUser" class="btn btn-sm btn-info"><i class="fa fa-plus"></i> Add Screen</button></th>
                ...
                while($screen=mysqli_fetch_array($sr))
                {
                  ...
                  <tr>
                    ...
                    <?php 
                      $st=mysqli_query($con,"select * from app_time_slot where screen_id='".$screen['screen_id']."'");
                    ?>
